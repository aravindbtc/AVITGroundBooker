...
import { ShieldAlert, Save, Loader2, AlertCircle, CalendarDays, Users, Trash2, PlusCircle, Phone, TrendingUp, DollarSign, CheckCircle2 } from "lucide-react";
...
function PriceStockManagement() {
    ...
    return (
         <Card className="w-full shadow-xl rounded-xl border-0 overflow-hidden bg-gradient-to-br from-slate-50 to-cyan-50">
            <CardHeader className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white pb-8">
                <div className="flex flex-row items-center justify-between">
                    <div className="space-y-2">
                        ...
                        <CardDescription className="text-cyan-100">Edit prices and available stock for accessories and manpower</CardDescription>
                    </div>
                    <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                    <DialogTrigger asChild>
                        <Button className="bg-white text-cyan-600 hover:bg-cyan-50 font-semibold shadow-lg">
            ...
            {isLoading ? (
                ...
                <>
                <Tabs defaultValue="accessories" className="w-full mt-6">
                    <TabsList className="grid w-full grid-cols-2 bg-gray-200 p-1 h-auto gap-1">
                      <TabsTrigger value="accessories" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-500 data-[state=active]:to-emerald-600 data-[state=active]:text-white py-2.5 font-semibold rounded-lg transition-all">
                        📦 Accessories
                      </TabsTrigger>
                      <TabsTrigger value="manpower" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-blue-600 data-[state=active]:text-white py-2.5 font-semibold rounded-lg transition-all">
                        👥 Manpower
                      </TabsTrigger>
                    </TabsList>
                    <TabsContent value="accessories" className="mt-6 border-0 bg-white rounded-lg p-4 shadow-sm">
                    <Table>
                        <TableHeader>
                        <TableRow className="border-b-2 border-green-200 bg-green-50">
                            <TableHead className="font-bold text-green-900">Item</TableHead>
                            <TableHead className="font-bold text-green-900">Price (Rs.)</TableHead>
                            <TableHead className="font-bold text-green-900">Stock</TableHead>
                        </TableRow>
                        </TableHeader>
                        <TableBody>
                        {accessories.map((addon) => (
                            <TableRow key={addon.id} className="border-b border-gray-200 hover:bg-green-50 transition-colors">
                            ...
                            <TableCell>
                                ...
                                className="h-9 w-24 border-green-300 focus:border-green-500 focus:ring-green-500"
                                />
                            </TableCell>
                            <TableCell>
                                <Input
                    ...
                    <TabsContent value="manpower" className="mt-6 border-0 bg-white rounded-lg p-4 shadow-sm">
                    <Table>
                        <TableHeader>
                        <TableRow className="border-b-2 border-blue-200 bg-blue-50">
                            <TableHead className="font-bold text-blue-900">Service</TableHead>
                            <TableHead className="font-bold text-blue-900">Price (per hour/booking)</TableHead>
                            <TableHead className="font-bold text-blue-900">Available</TableHead>
                            <TableHead className="font-bold text-blue-900">Contact</TableHead>
                        </TableRow>
                        </TableHeader>
                        <TableBody>
                        {manpower.map((person) => (
                            <TableRow key={person.id} className="border-b border-gray-200 hover:bg-blue-50 transition-colors">
                            <TableCell className="font-medium flex items-center gap-2">
                                {person.name}
                            </TableCell>
                            <TableCell>
                                ...
                                className="h-9 w-24 border-blue-300 focus:border-blue-500 focus:ring-blue-500"
                                />
                            </TableCell>
                            <TableCell>
                                <Input
                            ...
                            <TableCell>
                                ...
                                className="h-9 w-36 border-blue-300 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div className="flex justify-end mt-8">
                    <Button onClick={handleSaveChanges} disabled={isSaving} className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-bold px-6 py-2.5 shadow-lg transition-all">
...
function AllBookings() {
    ...
    return (
        <Card className="shadow-xl rounded-xl border-0 overflow-hidden bg-gradient-to-br from-slate-50 to-orange-50">
            <CardHeader className="bg-gradient-to-r from-orange-600 to-red-600 text-white pb-6">
                <div>
                    ...
                    <CardDescription className="text-orange-100 mt-2">View and manage all bookings made by users</CardDescription>
                </div>
            </CardHeader>
...
function UserManagement() {
    ...
    return (
        <Card className="shadow-xl rounded-xl border-0 overflow-hidden bg-gradient-to-br from-slate-50 to-purple-50">
            <CardHeader className="bg-gradient-to-r from-purple-600 to-pink-600 text-white pb-6">
                <div>
                    ...
                    <CardDescription className="text-purple-100 mt-2">View and manage all registered users on the platform</CardDescription>
                </div>
            </CardHeader>
            <CardContent className="pt-6">
                 {isLoading ? (
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <div className="inline-block">
            ...
            <p className="text-gray-300 text-base ml-12">Manage venue, pricing, bookings, and user accounts</p>
          </div>
        </div>
      </div>
