    ...
    return (
        <Collapsible asChild>
            ...
            <TableRow>
                ...
                <TableCell>
                    <Badge variant="outline" className={booking.paymentMethod === 'without-payment' ? 'bg-green-50' : 'bg-blue-50'}>
                        {booking.paymentMethod === 'without-payment' ? '🆓 Without Payment' : '💳 Razorpay'}
                    </Badge>
                </TableCell>
